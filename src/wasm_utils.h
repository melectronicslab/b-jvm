...
// Generated from https://github.com/WebAssembly/spec/blob/f3a0e06235d2d84bb0f3b5014da4370613886965/interpreter/binary/encode.ml
typedef enum {
  /* i32 unary */
...
typedef enum {
  ...
  /* Arithmetic/logical instructions (consume 2 numeric operands, produce 1 numeric) */
...
bjvm_wasm_type bjvm_wasm_make_tuple(bjvm_wasm_module *module, bjvm_wasm_value_type *components, int length);
...
bjvm_wasm_function *
bjvm_wasm_add_function(bjvm_wasm_module *module,
    bjvm_wasm_type params, bjvm_wasm_type results,
    bjvm_wasm_type locals,
    bjvm_wasm_expression *body, const char* name);

void bjvm_wasm_export_function(bjvm_wasm_module *module, bjvm_wasm_function *fn);
...
#define bjvm_wasm_import_runtime_function(module, c_name, params, result) \
  bjvm_wasm_import_runtime_function_impl(module, #c_name, params, result, &c_name)
...
bjvm_wasm_expression *bjvm_wasm_binop(
    bjvm_wasm_module *module,
    bjvm_wasm_binary_op_kind op,
    bjvm_wasm_expression *left,
    bjvm_wasm_expression *right);
...
bjvm_wasm_expression *bjvm_wasm_call(
  ...
  bjvm_wasm_expression **args,
  int arg_count);
bjvm_wasm_expression *bjvm_wasm_call_indirect(
  bjvm_wasm_module *module,
  int table_index,
  bjvm_wasm_expression *index,
  bjvm_wasm_expression **args,
  int arg_count);
bjvm_wasm_expression *bjvm_wasm_load(
    bjvm_wasm_module *module,
    bjvm_wasm_load_op_kind op,
    bjvm_wasm_expression *addr,
    int align,
    int offset);
bjvm_wasm_expression *bjvm_wasm_store(
    bjvm_wasm_module *module,
    bjvm_wasm_store_op_kind op,
    bjvm_wasm_expression *addr,
    bjvm_wasm_expression *value,
...
void bjvm_free_wasm_instantiation_result(bjvm_wasm_instantiation_result *result);
bjvm_wasm_instantiation_result *bjvm_wasm_instantiate_module(bjvm_wasm_module *module);
