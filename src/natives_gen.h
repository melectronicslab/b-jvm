...
struct bjvm_native_Field {
  ...
  bjvm_obj_header
      *genericInfo; // Lsun/reflect/generics/repository/FieldRepository;
...
struct bjvm_native_Method {
  ...
  bjvm_obj_header *signature;      // Ljava/lang/String;
  bjvm_obj_header
      *genericInfo; // Lsun/reflect/generics/repository/MethodRepository;
  bjvm_obj_header *annotations;          // [B
...
struct bjvm_native_Constructor {
  ...
  bjvm_obj_header *signature;      // Ljava/lang/String;
  bjvm_obj_header
      *genericInfo; // Lsun/reflect/generics/repository/ConstructorRepository;
  bjvm_obj_header *annotations;          // [B
  bjvm_obj_header *parameterAnnotations; // [B
...
struct bjvm_native_Thread {
  ...
  bjvm_obj_header
      *inheritedAccessControlContext; // Ljava/security/AccessControlContext;
...
static inline void bjvm_register_native_padding(bjvm_vm *vm) {
  (void)bjvm_hash_table_insert(&vm->class_padding, "sun/reflect/ConstantPool",
